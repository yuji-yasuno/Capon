...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if defualts.boolForKey("initialized") == false {
            defualts.setBool(true, forKey: "initialized")
            defualts.setValue("https://sdo-demo-main-14aa4263bf4.secure.force.com/easyflyer", forKey: "endpoint")
        }
